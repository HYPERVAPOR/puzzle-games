    ...
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className={cn(
          ...
          "focus-visible:ring-offset-zinc-950 dark:focus-visible:ring-offset-zinc-50",
          className
        )}
        aria-label="设置"
      ...
      {isOpen && (
        <div
          className={cn(
            ...
            "bg-zinc-900/95 dark:bg-white/95",
            "backdrop-blur-xl",
        ...
        >
          ...
          >
            <p
              className="text-xs font-medium text-zinc-500 dark:text-zinc-400 mb-2 px-1"
              role="none"
            >
              主题
            </p>
            <div className="space-y-1" role="group">
              ...
              <button
                ...
                className={cn(
                  ...
                  "text-left",
                  theme === 'dark'
                    ? "bg-emerald-500/10 text-emerald-400 dark:text-emerald-600"
                    : "text-zinc-400 dark:text-zinc-700 hover:bg-zinc-800/50 dark:hover:bg-zinc-100/50 hover:text-zinc-300 dark:hover:text-zinc-900"
                )}
                role="menuitemradio"
          ...
          {/* 分隔线 */}
          <div
            className="my-2 border-t border-zinc-800 dark:border-zinc-200"
            role="separator"
          />
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    "bg-zinc-700/50 dark:bg-zinc-300/50",
